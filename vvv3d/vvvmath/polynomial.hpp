...
inline poly<3, T> poly3fit(const double* x, const T* y)
{
    ...
    const T o2 = y0 + y1 + y2;
    const T o1 = -(x[1] + x[2]) * y0 - (x[0] + x[2]) * y1 - (x[0] + x[1]) * y2;
...
inline poly<5, T> poly5fit(const double* x, const T* y)
{
    ...
    const T o3 =
        -(y0 * (sx01234 - x0) + y1 * (sx01234 - x1) + y2 * (sx01234 - x2) +
          y3 * (sx01234 - x3) + y4 * (sx01234 - x4));
    ...
    const T o0 = y0 * x1 * x2 * x3 * x4 + y1 * x0 * x2 * x3 * x4 +
                 y2 * x0 * x1 * x3 * x4 + y3 * x0 * x1 * x2 * x4 +
                 y4 * x0 * x1 * x2 * x3;
...
template <typename T>
inline poly<5, T> poly5fit(const std::tr1::function<T(double)>& f, double start,
                           double end)
{
...
template <typename T>
inline poly<3, T> poly3fit(const std::tr1::function<T(double)>& f, double start,
                           double end)
{
