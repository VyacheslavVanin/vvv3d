...
template <typename T>
inline void matrix33<T>::mul(const matrix33<T>& lhs, const matrix33<T>& rhs,
                             matrix33<T>& out)
{
    const T x0 = lhs.matrix[0][0] * rhs.matrix[0][0] +
                 lhs.matrix[1][0] * rhs.matrix[0][1] +
                 lhs.matrix[2][0] * rhs.matrix[0][2];
    const T x1 = lhs.matrix[0][1] * rhs.matrix[0][0] +
                 lhs.matrix[1][1] * rhs.matrix[0][1] +
                 lhs.matrix[2][1] * rhs.matrix[0][2];
    const T x2 = lhs.matrix[0][2] * rhs.matrix[0][0] +
                 lhs.matrix[1][2] * rhs.matrix[0][1] +
                 lhs.matrix[2][2] * rhs.matrix[0][2];
    const T x3 = lhs.matrix[0][0] * rhs.matrix[1][0] +
                 lhs.matrix[1][0] * rhs.matrix[1][1] +
                 lhs.matrix[2][0] * rhs.matrix[1][2];
    const T x4 = lhs.matrix[0][1] * rhs.matrix[1][0] +
                 lhs.matrix[1][1] * rhs.matrix[1][1] +
                 lhs.matrix[2][1] * rhs.matrix[1][2];
    const T x5 = lhs.matrix[0][2] * rhs.matrix[1][0] +
                 lhs.matrix[1][2] * rhs.matrix[1][1] +
                 lhs.matrix[2][2] * rhs.matrix[1][2];
    const T x6 = lhs.matrix[0][0] * rhs.matrix[2][0] +
                 lhs.matrix[1][0] * rhs.matrix[2][1] +
                 lhs.matrix[2][0] * rhs.matrix[2][2];
    const T x7 = lhs.matrix[0][1] * rhs.matrix[2][0] +
                 lhs.matrix[1][1] * rhs.matrix[2][1] +
                 lhs.matrix[2][1] * rhs.matrix[2][2];
    const T x8 = lhs.matrix[0][2] * rhs.matrix[2][0] +
...
template <typename T>
inline matrix33<T> matrix33<T>::createMatrixFromColumns(const vector3<T>& v0,
                                                        const vector3<T>& v1,
                                                        const vector3<T>& v2)
{
    matrix33<T> ret;
...
template <typename T>
inline matrix33<T> matrix33<T>::createMatrixFromRows(const vector3<T>& v0,
                                                     const vector3<T>& v1,
                                                     const vector3<T>& v2)
{
    matrix33<T> ret;
...
template <typename T>
inline void matrix44<T>::mul(const matrix44& lhs, const matrix44& rhs,
                             matrix44<T>& out)
{
    const T out00 = lhs.matrix[0][0] * rhs.matrix[0][0] +
                    lhs.matrix[1][0] * rhs.matrix[0][1] +
                    lhs.matrix[2][0] * rhs.matrix[0][2] +
                    lhs.matrix[3][0] * rhs.matrix[0][3];
    const T out01 = lhs.matrix[0][1] * rhs.matrix[0][0] +
                    lhs.matrix[1][1] * rhs.matrix[0][1] +
                    lhs.matrix[2][1] * rhs.matrix[0][2] +
                    lhs.matrix[3][1] * rhs.matrix[0][3];
    const T out02 = lhs.matrix[0][2] * rhs.matrix[0][0] +
                    lhs.matrix[1][2] * rhs.matrix[0][1] +
                    lhs.matrix[2][2] * rhs.matrix[0][2] +
                    lhs.matrix[3][2] * rhs.matrix[0][3];
    const T out03 = lhs.matrix[0][3] * rhs.matrix[0][0] +
                    lhs.matrix[1][3] * rhs.matrix[0][1] +
                    lhs.matrix[2][3] * rhs.matrix[0][2] +
                    lhs.matrix[3][3] * rhs.matrix[0][3];

    const T out10 = lhs.matrix[0][0] * rhs.matrix[1][0] +
                    lhs.matrix[1][0] * rhs.matrix[1][1] +
                    lhs.matrix[2][0] * rhs.matrix[1][2] +
                    lhs.matrix[3][0] * rhs.matrix[1][3];
    const T out11 = lhs.matrix[0][1] * rhs.matrix[1][0] +
                    lhs.matrix[1][1] * rhs.matrix[1][1] +
                    lhs.matrix[2][1] * rhs.matrix[1][2] +
                    lhs.matrix[3][1] * rhs.matrix[1][3];
    const T out12 = lhs.matrix[0][2] * rhs.matrix[1][0] +
                    lhs.matrix[1][2] * rhs.matrix[1][1] +
                    lhs.matrix[2][2] * rhs.matrix[1][2] +
                    lhs.matrix[3][2] * rhs.matrix[1][3];
    const T out13 = lhs.matrix[0][3] * rhs.matrix[1][0] +
                    lhs.matrix[1][3] * rhs.matrix[1][1] +
                    lhs.matrix[2][3] * rhs.matrix[1][2] +
                    lhs.matrix[3][3] * rhs.matrix[1][3];

    const T out20 = lhs.matrix[0][0] * rhs.matrix[2][0] +
                    lhs.matrix[1][0] * rhs.matrix[2][1] +
                    lhs.matrix[2][0] * rhs.matrix[2][2] +
                    lhs.matrix[3][0] * rhs.matrix[2][3];
    const T out21 = lhs.matrix[0][1] * rhs.matrix[2][0] +
                    lhs.matrix[1][1] * rhs.matrix[2][1] +
                    lhs.matrix[2][1] * rhs.matrix[2][2] +
                    lhs.matrix[3][1] * rhs.matrix[2][3];
    const T out22 = lhs.matrix[0][2] * rhs.matrix[2][0] +
                    lhs.matrix[1][2] * rhs.matrix[2][1] +
                    lhs.matrix[2][2] * rhs.matrix[2][2] +
                    lhs.matrix[3][2] * rhs.matrix[2][3];
    const T out23 = lhs.matrix[0][3] * rhs.matrix[2][0] +
                    lhs.matrix[1][3] * rhs.matrix[2][1] +
                    lhs.matrix[2][3] * rhs.matrix[2][2] +
                    lhs.matrix[3][3] * rhs.matrix[2][3];

    const T out30 = lhs.matrix[0][0] * rhs.matrix[3][0] +
                    lhs.matrix[1][0] * rhs.matrix[3][1] +
                    lhs.matrix[2][0] * rhs.matrix[3][2] +
                    lhs.matrix[3][0] * rhs.matrix[3][3];
    const T out31 = lhs.matrix[0][1] * rhs.matrix[3][0] +
                    lhs.matrix[1][1] * rhs.matrix[3][1] +
                    lhs.matrix[2][1] * rhs.matrix[3][2] +
                    lhs.matrix[3][1] * rhs.matrix[3][3];
    const T out32 = lhs.matrix[0][2] * rhs.matrix[3][0] +
                    lhs.matrix[1][2] * rhs.matrix[3][1] +
                    lhs.matrix[2][2] * rhs.matrix[3][2] +
                    lhs.matrix[3][2] * rhs.matrix[3][3];
    const T out33 = lhs.matrix[0][3] * rhs.matrix[3][0] +
                    lhs.matrix[1][3] * rhs.matrix[3][1] +
                    lhs.matrix[2][3] * rhs.matrix[3][2] +
...
template <typename T>
inline matrix44<T>& matrix44<T>::loadTranslation(const T& x, const T& y,
                                                 const T& z)
{
...
{
    const T x = matrix[0][0] * in.x + matrix[1][0] * in.y +
                matrix[2][0] * in.z + matrix[3][0] * in.w;
    const T y = matrix[0][1] * in.x + matrix[1][1] * in.y +
                matrix[2][1] * in.z + matrix[3][1] * in.w;
    const T z = matrix[0][2] * in.x + matrix[1][2] * in.y +
                matrix[2][2] * in.z + matrix[3][2] * in.w;
    const T w = matrix[0][3] * in.x + matrix[1][3] * in.y +
                matrix[2][3] * in.z + matrix[3][3] * in.w;
...
{
    const T x = matrix[0][0] * in.x + matrix[1][0] * in.y +
                matrix[2][0] * in.z + matrix[3][0];
    const T y = matrix[0][1] * in.x + matrix[1][1] * in.y +
                matrix[2][1] * in.z + matrix[3][1];
    const T z = matrix[0][2] * in.x + matrix[1][2] * in.y +
                matrix[2][2] * in.z + matrix[3][2];
    out.set(x, y, z);
}
...
template <typename T>
inline matrix44<T>& matrix44<T>::loadLookAt(const vector3<T>& eye,
                                            ...
                                            const vector3<T>& up)
{
    ...
    return loadFromColumns(
        vector4<T>(xaxis.x, yaxis.x, zaxis.x, 0),
